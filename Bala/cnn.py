...
classifier.fit_generator(
        training_set,
        steps_per_epoch=368,               #Number of images in the Training_set
        epochs=20,                           #GPU => 50 / 100 .....
        validation_data=test_set,
        validation_steps=92)              #Number of images in the Test_set
